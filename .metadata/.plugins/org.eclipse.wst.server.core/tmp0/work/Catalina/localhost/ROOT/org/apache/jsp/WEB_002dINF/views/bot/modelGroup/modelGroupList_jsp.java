 ...
 * Generated at: 2018-05-09 10:24:09 UTC
...
public final class modelGroupList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"content\" id=\"modelGroup\">\r\n");
      out.write("\t<div class=\"sub_layout\">\r\n");
      out.write("\t\t<!-- 17.12.12 수정 -->\r\n");
      out.write("\t\t<div class=\"tb_desc\">\r\n");
      out.write("\t\t\t<p>조회결과 : {{ modelGroupList.length | number}}건</p>\r\n");
      out.write("\t\t\t<button class=\"g_btn01\" @click=\"showPopupLayer('/bot/modelGroup/modelGroupForm'); return false;\">장비모델 분류 추가</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"g_table\">\r\n");
      out.write("\t\t\t<table>\r\n");
      out.write("\t\t\t\t<caption>분류명칭 </caption>\r\n");
      out.write("\t\t\t\t<colgroup>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>{{ list.modelType | code(codeNm) }}</td>\r\n");
      out.write("\t\t\t\t\t\t<td><a href=\"#\" class=\"link\" @click=\"showPopupLayer('/bot/modelGroup/modelGroupForm?modelGroupId=' + list.modelGroupId); return false;\">{{list.modelGroupNm}}</a></td>\r\n");
      out.write("\t\t\t\t\t\t<td><span class=\"icon\"><img :src=\"list.imgUrl\"></span></td>\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr v-if=\"modelGroupList.length == 0\">\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\">등록된 분류가 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\tvar modelGroup = new Vue({\r\n");
      out.write("\t\tel: \"#modelGroup\"\r\n");
      out.write("\t\t, data: {\r\n");
      out.write("\t\t\tmodelGroupList: {\r\n");
      out.write("\t\t\t\timgUrl: \"\"\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t$.get(\"/bot/modelGroup/getModelGroupList\", function(data){\r\n");
      out.write("\t\t\t\t\tmodelGroup.modelGroupList = data.modelGroupList;\r\n");
      out.write("\t\t\t\t\tfor(var i=0; i < data.modelGroupList.length; i++){\r\n");
      out.write("\t\t\t\t\t\tif (data.modelGroupList[i].icon != \"\"){\r\n");
      out.write("\t\t\t\t\t\t\tmodelGroup.modelGroupList[i].imgUrl = \"/images/bot/ico_model_\" + data.modelGroupList[i].icon + \".png\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tmodelGroup.getPagingList();\r\n");
      out.write("\t\t\t\t\tmodelGroup.goPage(1);\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t, getPagingList: function (){\r\n");
      out.write("\t\t\t\tthis.pagingList = this.$refs.paginator.pagingList(this.modelGroupList);\r\n");
      out.write("\t\t\t}\r\n");
  ...
  private boolean _jspx_meth_nl_005fcodeListJson_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/bot/modelGroup/modelGroupList.jsp(53,14) name = codeType type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_nl_005fcodeListJson_005f0.setCodeType("C200");
