 ...
 * Generated at: 2018-07-27 01:16:34 UTC
...
return;
    ...
    try {
      ...
      out.write("\t<div class=\"sub_layout has_snb\" v-if=\"project.projectStatCd !='C304'\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<a v-if=\"m.pageType == 'C103'\" href=\"#\" @click=\"goModalView(m.menuUrl)\"><span class=\"ico\"><img :src=\"'/images/qa/ico_qa_set_' + m.menuId + '.png'\" :alt=\"m.menuNm\"></span><span class=\"name\">{{m.menuNm}}</span></a>\r\n");
      out.write("\t\t\t\t\t\t<a v-else :href=\"m.menuUrl\"><span class=\"ico\"><img :src=\"'/images/qa/ico_qa_set_' + m.menuId + '.png'\" :alt=\"m.menuNm\"></span><span class=\"name\">{{m.menuNm}}</span></a>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"only_btn\" v-if=\"project.chasuStat == 'Y'\"><strong>{{ project.chasu }}</strong>회차</p>\r\n");
      out.write("\t\t\t\t\t\t<p class=\"only_btn\" v-else>수정개발중</p>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn_default\" @click=\"modProjectNextChasu\">다음회차시작</button>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t<span>프로젝트</span>\r\n");
      out.write("\t\t\t\t\t\t<p><strong class=\"point_cr\">{{ project.projectStatCd | code(projectStatNm) }}</strong></p>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"state_desc\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" v-model=\"projectQaMm\" placeholder=\"QA M/M 입력\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" v-model=\"projectBpMm\" placeholder=\"BP M/M 입력\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"state_desc\">\r\n");
      out.write("\t\t\t\t\t\t\t");
      //  nl:select
      ...
      // /WEB-INF/views/qa/projectMng.jsp(31,7) null
      _jspx_th_nl_005fselect_005f0.setDynamicAttribute(null, "v-model", "projectResultStat");
      // /WEB-INF/views/qa/projectMng.jsp(31,7) name = id type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_nl_005fselect_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            // /WEB-INF/views/qa/projectMng.jsp(32,8) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn_default\" @click=\"modProjectComplete\">프로젝트 완료 처리</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t<li v-if=\"userGroupId == 'G01'\">\r\n");
      ...
      out.write("\t\t\t\t\t<button class=\"g_btn01\" @click=\"delProject\" v-if=\"userGroupId == 'G01'\">프로젝트 삭제</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t, projectQaMm: ''\r\n");
      out.write("\t\t\t, projectBpMm: ''\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t\t$.get(\"/qa/project/getProjectView?pid=\"+ this.pid, function(data){\r\n");
      out.write("\t\t\t\t\tcont.project = data.projectView;\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t, modProjectNextChasu: function() {\r\n");
      out.write("\t\t\t\tif (this.proc) return;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar param = { \r\n");
      out.write("\t\t\t\t\t\tpid: this.pid\r\n");
      out.write("\t\t\t\t\t\t, chasu : this.project.chasu\r\n");
      out.write("\t\t\t\t\t\t, chasuStat : this.project.chasuStat\r\n");
      out.write("\t\t\t\t\t};\r\n");
      out.write("\t\t\t\tvar confirmStr = \"다음 차수로 변경 하시겠습니까?\";\r\n");
      out.write("\t\t\t\tvar completeStr = \"다음 차수로 변경 되었습니다.\";\r\n");
      out.write("\t\t\t\tif (cont.project.chasuStat === 'Y') {\r\n");
      out.write("\t\t\t\t\tconfirmStr = \"수정개발 상태로 변경 하시겠습니까?\";\r\n");
      out.write("\t\t\t\t\tcompleteStr = \"수정개발 상태로 변경 되었습니다.\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif (!confirm(confirmStr)) return;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tcont.proc = true;\r\n");
      out.write("\t\t\t\t$.post(\"/qa/project/modNextProjectChasuPrc\", param, function(data) {\r\n");
      ...
      out.write("\t\t\t\tvar param = { pid: this.pid }\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif (!confirm(\"프로젝트를 삭제하시겠습니까?\")) return;\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\ttype: \"post\"\r\n");
      out.write("\t\t\t\t\t, url: \"/qa/project/modProjectUseYnPrc\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\tlocation.href = \"/qa/main\";\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\tcont.proc = true;\r\n");
      out.write("\t\t\t\t$.post(\"/qa/project/modProjectRestartPrc\", param, function(data) {\r\n");
      out.write("\t\t\t\t\tif (data.save) {\r\n");
      ...
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif (this.projectQaMm == \"\") {\r\n");
      out.write("\t\t\t\t\talert(\"프로젝트 QA M/M을 해주세요.\")\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif (this.projectBpMm == \"\") {\r\n");
      out.write("\t\t\t\t\talert(\"프로젝트 BP M/M을 해주세요.\")\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar param = {\r\n");
      ...
      out.write("\t\t\t\t\t, projectQaMm : this.projectQaMm\r\n");
      out.write("\t\t\t\t\t, projectBpMm : this.projectBpMm\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif (this.proc) return;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif (!confirm(\"프로젝트 완료처리를 하시겠습니까?\")) return;\r\n");
      out.write("\t\t\t\tcont.proc = true;\r\n");
      out.write("\t\t\t\t$.post(\"/qa/project/modProjectCompletePrc\", param, function(data) {\r\n");
      out.write("\t\t\t\t\tif (data.save) {\r\n");
  ...
  private boolean _jspx_meth_nl_005foptions_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_nl_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_nl_005fselect_005f0)
    ...
    // /WEB-INF/views/qa/projectMng.jsp(33,8) name = codeType type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/qa/projectMng.jsp(63,11) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_nl_005fcodeListJson_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/qa/projectMng.jsp(65,21) name = codeType type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/qa/projectMng.jsp(66,19) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/qa/projectMng.jsp(72,53) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
