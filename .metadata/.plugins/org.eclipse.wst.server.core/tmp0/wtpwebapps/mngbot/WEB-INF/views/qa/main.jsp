						...
						<li class="project-section" v-for="list in projectOverviewList">
							...
							<a :href="list.href" class="project-section-title accordion_link">
								<div class="pov-dwrap">
									...
									<p v-if = "list.chasuStat == 'Y' || list.projectStatCd == 'C304'">차수 : {{list.chasu}}차</p>
							...
							<div :id="list.id" class="project-section-content accordion_target">
								<dl>
									...
									<dt>예상 M/M</dt>
									<dd>
										<span class="txt_mm">QA : {{list.predictionQaMm}}</span>
										<span class="txt_mm">BP : {{list.predictionBpMm}}</span>
									</dd>
									<dt>소요 M/M</dt>
									<dd>
										<span class="txt_mm">QA : {{list.projectQaMm}}</span>
										<span class="txt_mm">BP : {{list.projectBpMm}}</span>
									</dd>
									<dt>측정모델</dt>
									<dd>
