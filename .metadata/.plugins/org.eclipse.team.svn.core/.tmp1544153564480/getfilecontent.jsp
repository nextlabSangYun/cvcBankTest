		...
		<div class="cont_wrap">
			...
			<div class="now_state" v-if="heProjectView.projectStat != 'C304'">
				<ul>
					...
					<li class="setting_list" v-if="userGroupId == 'G13'">
						<a href="#" @click="delHeProject"><span class="name">프로젝트 삭제</span></a>
					</li>
			...
			<div class="now_state" v-else>
				<ul>
					<li>
						...
						<button v-if="userGroupId == 'G13'" class="btn_default" @click="delHeProject">프로젝트 삭제</button>
					</li>
				</ul>
