...
public class CodeComponent {
	...
	public CodeVo getCodeByCodeValue(String codeType, String codeValue) {
		List<CodeVo> tmpCodeList = codeMap.get(codeType);
		for (CodeVo code : tmpCodeList) {
			if (StringUtils.equalsIgnoreCase(code.getCodeNm(), codeValue) || StringUtils.equalsIgnoreCase(code.getCodeId(), codeValue)) {
				return code;
			}
		}
		return null;
