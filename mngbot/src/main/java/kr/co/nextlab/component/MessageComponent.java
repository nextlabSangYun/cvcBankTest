...
public class MessageComponent {
	 ...
	 * @return 이슈 생성 메시지
	 */
	public MessageVo setMessageCreateHeIssue(HeProjectIssueVo heProjectIssueVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		messageVo.setAppId(appId);
		messageVo.setPid(heProjectIssueVo.getPid());
		messageVo.setSubject("이슈 처리요청 : " + heProjectIssueVo.getIssueSubject());
		messageVo.setContent("이슈 '" + heProjectIssueVo.getIssueSubject() + "'에 대한 처리요청이 생성되었습니다.");
		messageVo.setLinkUrl("/hded/issue/issueList?pid=" + heProjectIssueVo.getPid() + "&issueId=" + heProjectIssueVo.getIssueId());
		return messageVo;
	}
	 ...
	 * @return 이슈 생성 메시지
	 */
	public MessageVo setMessageCompleteHeIssue(HeProjectIssueVo heProjectIssueVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		messageVo.setAppId(appId);
		messageVo.setPid(heProjectIssueVo.getPid());
		messageVo.setSubject("이슈 해결완료 알림 : " + heProjectIssueVo.getIssueSubject());
		messageVo.setContent("이슈 '" + heProjectIssueVo.getIssueSubject() + "'가 해결완료 되었습니다.");
		messageVo.setLinkUrl("/hded/issue/issueList?pid=" + heProjectIssueVo.getPid() + "&issueId=" + heProjectIssueVo.getIssueId());
		return messageVo;
	}
	 ...
	 * @return 이슈 생성 메시지
	 */
	public MessageVo setMessageRecallHeIssue(HeProjectIssueVo heProjectIssueVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		messageVo.setAppId(appId);
		messageVo.setPid(heProjectIssueVo.getPid());
		messageVo.setSubject("이슈 재오픈 알림 : " + heProjectIssueVo.getIssueSubject());
		messageVo.setContent("이슈 '" + heProjectIssueVo.getIssueSubject() + "'가 재오픈 되었습니다.");
		messageVo.setLinkUrl("/bmt/issue/issueList?pid=" + heProjectIssueVo.getPid() + "&issueId=" + heProjectIssueVo.getIssueId());
		return messageVo;
	}
	 ...
	 * @return 이슈 생성 메시지
	 */
	public MessageVo setMessageHeIssueComment(HeProjectIssueVo heProjectIssueVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		...
		messageVo.setPid(heProjectIssueVo.getPid());
		messageVo.setSubject("이슈 처리요청 : " + heProjectIssueVo.getIssueSubject());
		messageVo.setContent("이슈 '" + heProjectIssueVo.getIssueSubject() + "'의 코멘트가 추가되었습니다.");
		messageVo.setLinkUrl("/bmt/issue/issueList?pid=" + heProjectIssueVo.getPid() + "&issueId=" + heProjectIssueVo.getIssueId());
		return messageVo;
	}
	 ...
	 * @return 프로젝트 생성 메시지
	 */
	public MessageVo setMessageCreateQaProject(QaProjectVo qaProjectVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		messageVo.setAppId(appId);
		messageVo.setPid(qaProjectVo.getPid());
		messageVo.setSubject("프로젝트 참여알림 : " + qaProjectVo.getProjectNm());
		messageVo.setContent("QA 프로젝트 '" + qaProjectVo.getProjectNm() + "'에 참여자로 등록되었습니다.");
		messageVo.setLinkUrl("/qa/projectMain?pid=" + qaProjectVo.getPid());
		return messageVo;
	}
	 ...
	 * @return 프로젝트 생성 메시지
	 */
	public MessageVo setMessageCompleteQaProject(QaProjectVo qaProjectVo, String appId, UserVo userVo) {
		MessageVo messageVo = new MessageVo();
		messageVo.setSendUserNm(userVo.getUserNm());
		messageVo.setSendUserId(userVo.getUserId());
		messageVo.setSendUserImg(this.getSendUserImg(userVo));
		messageVo.setAppId(appId);
		messageVo.setPid(qaProjectVo.getPid());
		messageVo.setSubject("프로젝트 완료알림 : " + qaProjectVo.getProjectNm());
		messageVo.setContent("QA 프로젝트 '" + qaProjectVo.getProjectNm() + "'가 완료처리 되었습니다.");
		messageVo.setLinkUrl("/qa/projectMain?pid=" + qaProjectVo.getPid());
		return messageVo;
	}
}
