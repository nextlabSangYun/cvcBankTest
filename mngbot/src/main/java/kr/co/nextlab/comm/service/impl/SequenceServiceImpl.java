...
public class SequenceServiceImpl implements SequenceService {
	...
	*/
	...
	public String getHdProjectId() {
        ...
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("hePid", today);
        return key + today + projectId;
	}

	/**
	 * headend system id 채번
	 * S YYYYMM NO
	 */
	@Override
	public String getHdSystemId() {
		String key = "S";
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMM").format(now);
        String projectId = this.next("heSystemId", today);
        return key + today + projectId;
	}

	/**
	 * headend category id 채번
	 * C YYYYMMDD SEQSEQ
	 */
	@Override
	public String getHdCategoryId() {
		String key = "C";
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("heTcCateId", today);
        return key + today + projectId;
	}

	/**
	 * headend test case id 채번
	 * T YYYYMMDD SEQSEQ
	 */
	@Override
	public String getHdTcId() {
        ...
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("heTcId", today);
        return key + today + projectId;
	}
	 ...
	 */
	@Override
	public String getHdIssueId() {
		String key = "I";
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("heIssueId", today);
        return key + today + projectId;
	}
	...
	public String getQaProjectId() {
        ...
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("qaPid", today);
        return key + today + projectId;
	}
	...
	public String getQaCategoryId() {
        ...
        Date now = new Date();
        String today = new SimpleDateFormat("yyyyMMdd").format(now);
        String projectId = this.next("qaTcId", today);
        return key + today + projectId;
	}
