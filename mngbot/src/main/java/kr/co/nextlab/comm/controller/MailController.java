...
public class MailController extends BaseController {
	 ...
	 */
	@Access
	@RequestMapping("/mail/qa/newProject")
	public void qaNewProject(Model model, String userNm, @RequestBody QaProjectVo qaProjectVo){
		model.addAttribute("nowDate", new SimpleDateFormat("yyyy.MM.dd").format(new Date()));
		model.addAttribute("qaProjectVo", qaProjectVo);
		model.addAttribute("userNm", userNm);
	}
	 ...
	 */
	@Access
	@RequestMapping("mail/bmt/bmtIssueDecisionMaking")
	public void bmtIssueDecision(Model model, String userNm, @RequestBody DecisionMakingVo decisionMakingVo){
		model.addAttribute("nowDate", new SimpleDateFormat("yyyy.MM.dd").format(new Date()));
		model.addAttribute("decisionMakingVo", decisionMakingVo);
		model.addAttribute("userNm", userNm);
		String url = domainUrl + ":" + domainPort + "/bmt/issue/decisionMaking?pid=" + decisionMakingVo.getPid();
		model.addAttribute("url", url);
		String voteCont = decisionMakingVo.getVoteCont().replace("\n", "<br>");
		model.addAttribute("voteCont", voteCont);
	}
	
	/**
	 * 프로젝트 등록시 자동화 스크립트 작업 요청 메일 폼
	 * @param model
	 */
	@Access
	@RequestMapping("/mail/bmt/autoScriptWork")
	public void autoScriptWork(Model model, @RequestBody ProjectVo proejctVo) {
		model.addAttribute("nowDate", new SimpleDateFormat("yyyy.MM.dd").format(new Date()));
		model.addAttribute("proejctVo", proejctVo);
	}
