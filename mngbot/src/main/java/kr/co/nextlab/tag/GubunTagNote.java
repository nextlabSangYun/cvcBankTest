...
public class GubunTagNote {
	...
	/**
	 * 중요도/Critical, Majo. Minor
	 */
	@Getter
	@SuppressWarnings("serial")
	private final List<GubunVo> importanceCheck = new ArrayList<GubunVo>(3) {
		{
			add(new GubunVo("B103", "Critical"));
			add(new GubunVo("B101", "Major"));
			add(new GubunVo("B102", "Minor"));
		}
	};
	/**
	 * 진행사항/오픈, 수정중, 수정완료
	...
	@Getter
	@SuppressWarnings("serial")
	private final List<GubunVo> progressStatCheck = new ArrayList<GubunVo>(3) {
		{
			add(new GubunVo("B201", "오픈"));
			add(new GubunVo("B202", "수정중"));
			add(new GubunVo("B203", "수정완료"));
		}
	};
}
