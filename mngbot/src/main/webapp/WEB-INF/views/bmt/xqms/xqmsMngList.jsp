						...
						<table>
							...
							<tbody>
								<tr v-for="(list,index) in bmtPagingList " >
									...
									<td><a v-if="prjVo.projectStat != 'C304'" class="btn_edit" @click="goShowPopupLayer('/bmt/xqms/xqmsMngForm?xqmsSeq=' + list.xqmsSeq + '&xqmsType=' + list.xqmsType + '&pid=' + criteria.pid); return false;"></a></td>
								</tr>
	...
	var xqmsMng = new Vue({
		...
		, methods: {
			...
			, getBmtPagingList: function(){
				...
				var tempList = [];
				tempList = this.$refs.bmtPaginator.pagingList(this.projectXqmsMngBmtList);
			...
			, getLkfsPagingList: function(){
				xqmsMng.selectXqmsSeq.xqmsSeqArray = [];
				var tempList = [];
				tempList = this.$refs.lkfsPaginator.pagingList(this.projectXqmsMngLkfsList);
			...
			, getRemoconRobotPagingList: function(){
				xqmsMng.selectXqmsSeq.xqmsSeqArray = [];
				var tempList = [];
				tempList = this.$refs.remoconRobotPaginator.pagingList(this.projectXqmsMngRemoconRobotList);
			...
			, getChannelPagingList: function(){
				xqmsMng.selectXqmsSeq.xqmsSeqArray = [];
				var tempList = [];
				tempList = this.$refs.channelPaginator.pagingList(this.projectXqmsMngChannelList);
			...
			, getUiReactionPagingList: function(){
				xqmsMng.selectXqmsSeq.xqmsSeqArray = [];
				var tempList = [];
				tempList = this.$refs.uiReactionPaginator.pagingList(this.projectXqmsMngUiReactionList);
