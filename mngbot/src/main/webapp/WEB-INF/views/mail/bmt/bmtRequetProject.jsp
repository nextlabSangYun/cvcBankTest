				...
				<tr>
					<td style="padding:35px;border:1px solid #ddd;border-top:0;">
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td style="padding-bottom:30px;border-bottom:1px dashed #ddd;font-size:30px;color:#333">BMT 요청서 접수 알림</td>
							</tr>
							<tr>
								<td style="padding:26px 0;font-size:14px;color:#666">
									<c:out value="${userNm}"/>님! BMT 요청서가 접수 되었습니다.<br> 자세한 내용은 BMT 요청센터에서 확인 부탁드립니다.</td>
							</tr>
							<tr>
								<td>
									<table cellpadding="0" cellspacing="0" width="100%" >
										...
										<tr>
											<th style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;border-right:1px solid #dadada;font-size:14px;color:#444;background:#f0f0f0">요청자</th>
											<td style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;font-size:14px;color:#666;"><c:out value="${bmtRequestVo.petitorNm}"/>(<c:out value="${bmtRequestVo.petitorGroupNm}"/>)</td>
										</tr>
										<tr>
											<th style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;border-right:1px solid #dadada;font-size:14px;color:#444;background:#f0f0f0">요청 일시</th>
