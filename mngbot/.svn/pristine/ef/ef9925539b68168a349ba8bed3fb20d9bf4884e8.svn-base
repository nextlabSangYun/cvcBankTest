...
public interface HdedProjectMapper {
	 ...
	 * @return
	 */
	public int updateHeProjectUseYn(HeProjectVo heProjectvo);
	...
	/**
	 * 차수변경시 TC total count 및 TC pass, fail count 통계 테이블에 insert
	 * @param heSystemChasuHstVo
	 * @return
	 */
	public int insertProSysChasuTcStats(HeSystemChasuHstVo heSystemChasuHstVo);
	 ...
	 * @return
	 */
	public int updateRestartHeProject(HeProjectVo heProjectvo);
}
