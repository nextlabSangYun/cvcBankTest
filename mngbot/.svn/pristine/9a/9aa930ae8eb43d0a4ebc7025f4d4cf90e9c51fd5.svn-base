				...
				<tr>
					<td style="padding:35px;border:1px solid #ddd;border-top:0;">
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td style="padding-bottom:30px;border-bottom:1px dashed #ddd;font-size:30px;color:#333">BMT 요청서 반려 알림</td>
							</tr>
							<tr>
								<td style="padding:26px 0;font-size:14px;color:#666">
									<c:out value="${bmtRequestVo.regNm}"/>님! BMT 요청서가 반려되었습니다. <br>자세한 내용은 BMT 요청센터에서 확인 부탁드립니다.</td>
							</tr>
							<tr>
								<td>
									<table cellpadding="0" cellspacing="0" width="100%" >
										...
										<tr>
											<th style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;border-right:1px solid #dadada;font-size:14px;color:#444;background:#f0f0f0">반려자</th>
										...
										<tr>
											<th style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;border-right:1px solid #dadada;font-size:14px;color:#444;background:#f0f0f0">반려 일시</th>
										...
										<tr>
											<th style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;border-right:1px solid #dadada;font-size:14px;color:#444;background:#f0f0f0">반려 사유</th>
											<td style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;font-size:14px;color:#666;line-height:23px;"><c:out value="${bmtRequestVo.cancelReason}"/></td>
										</tr>
									</table>
								</td>
							</tr>
