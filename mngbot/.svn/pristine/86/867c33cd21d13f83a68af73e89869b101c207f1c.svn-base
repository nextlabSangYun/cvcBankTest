				...
				<tr>
					<td style="padding:35px;border:1px solid #ddd;border-top:0;">
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td style="padding:26px 0;font-size:14px;color:#666"><c:out value="${userNm}"/>님은 새 프로젝트 [<c:out value="${heProjectVo.projectNm}"/>] 에 구성원으로 등록되었습니다.</td>
							</tr>
							<tr>
								<td>
									<table cellpadding="0" cellspacing="0" width="100%" >
										<tr>
											<th style="padding:12px 18px;text-align:left;border:1px solid #dadada;border-left:0;width:114px;font-size:14px;color:#444;background:#f0f0f0">프로젝트구분</th>
											<td style="padding:12px 18px;text-align:left;border:solid #dadada;border-width:1px 0;font-size:14px;color:#666;">Head-end Test</td>
										</tr>
										<tr>
											...
											<td style="padding:12px 18px;text-align:left;border:solid #dadada;border-width:1px 0;font-size:14px;color:#666;"><c:out value="${heProjectVo.projectNm}"/></td>
										</tr>
										<tr>
											...
											<td style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;font-size:14px;color:#666;"><c:out value="${projectStDt}"/> ~ <c:out value="${projectEtDt}"/></td>
										</tr>
										<tr>
											...
											<td style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;font-size:14px;color:#666;line-height:23px;">
												<c:forEach var="list" items="${heProjectVo.managerList}" varStatus="num">
										...
										<tr>
											...
											<td style="padding:12px 18px;text-align:left;border-bottom:1px solid #dadada;font-size:14px;color:#666;line-height:23px;"><c:out value="${proejctVo.bigo}"/></td>
										</tr>
									</table>
								</td>
							</tr>
