...
public interface XqmsMapper {
	 ...
	 * @return
	 */
	public int updateLastBmtResult(XqmsVo xqmsVo);
	 ...
	 * @return
	 */
	public int updateLastChannelResult(XqmsVo xqmsVo);
	 ...
	 * @return
	 */
	public int updateLastUiReactionResult(XqmsVo xqmsVo);
	 ...
	 * @return
	 */
	public int updateLastLkfsResult(XqmsVo xqmsVo);
	 ...
	 * @return
	 */
	public int updateLastRemoconRobotResult(XqmsVo xqmsVo);
	...
	/**
	 * 측정이력관리 Xqmsdata 삭제 처리 전 lkfs 삭제 data 삭제
	 * @param criteria
	 * @return
	 */
	 ...
	 * @return
	 */
	public int deleteProjectXqmsLkfs(String xqmsSeq);
